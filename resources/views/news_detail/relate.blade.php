        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="row news-slide">
                    ...
                    <a href="{{url('news/detail')}}/{{$val->id}}" class="col-12 col-sm-4 activity-block">
                        ...
                        <div class="@if($key != 0) mb-xs-3 @endif"><img class="img-fluid w-100" src="{{asset('storage/images/news/thumb')}}/{{$val->thumb}}" alt="{{$val->seo}}"></div>
