...
<div class="pull-left col-xs-12" style="margin-top:15px;">
    <div class="box box-warning">
        ...
        <!-- form start -->
        {{ Form::open(array('url' => 'backend/laws/cate/edit/'.$category->id, 'method' => 'post','enctype' => 'multipart/form-data')) }}
        {{csrf_field()}}
            <div class="box-body">
                ...
                <div class="form-group">
                    <img style="margin-bottom:15px; max-width:100%;" src="{{asset('storage/images/cate_laws')}}/{{$category->thumb}}" />
