        ...
        {{csrf_field()}}
            <div class="box-body">
                ...
                <div id="addcate" class="form-group">
                    ...
                    <a href="{{url('/backend/knowledge/cate/add')}}" id="addcatebtn" class="addcate btn btn-primary" data-disable="true">+ Add New Category</a>
                </div>
                @endif
                <div class="form-group">
                    <label for="title">Title</label>
                    <input name="title" type="text" class="form-control" id="title" placeholder="Enter title of knowledge" data-error="กรุณากรอกหัวข้อ" maxlength="255" required>
