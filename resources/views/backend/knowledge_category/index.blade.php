...
<ol class="breadcrumb">
    ...
    <li class="active">Knowledge Categories</li>
</ol>
@stop
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Knowledge Category</h3><div class="pull-right"><a class="d-block btn btn-info" href="{{url('backend/knowledge/cate/add')}}"><i class="fa fa-plus-square"></i> Add Category</a></div>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        <div class="row">
