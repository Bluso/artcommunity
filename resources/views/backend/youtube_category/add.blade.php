...
<h1 class="pull-left">Categorires of Youtube</h1>
...
<div class="pull-left col-xs-12" style="margin-top:15px;">
    <div class="box box-warning">
        ...
        <!-- form start -->
        {{ Form::open(array('url' => 'backend/youtube/cate/add', 'method' => 'post','enctype' => 'multipart/form-data','id'=>'form-validate','data-toggle'=>'validator','role'=>'form')) }}
        {{csrf_field()}}
            <div class="box-body">
                <div class="form-group">
                    <label for="title">Title</label>
                    <input name="title" type="text" class="form-control" id="title" placeholder="Enter title of Youtube" data-error="กรุณากรอกชื่อหัวข้อ" maxlength="255" required>
