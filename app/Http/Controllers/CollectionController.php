  ...
  public function fav(Request $request)
  {
      ...
      if ($count_collection > 0) {
        ...
        if ($favcollectiontoggle->is_fav==0) {
          ...
          $collection->favorite_count = $collection->favorite_count+1;
          $collection->save();
        }
        else {
        ...
        return array($favcollectiontoggle->is_fav, $collection->favorite_count);
      }else{
        $favcollection = new UserLikeCollection;
        $favcollection->user_id = $request->input('user_id');
        $favcollection->collection_id = $request->input('collection_id');
