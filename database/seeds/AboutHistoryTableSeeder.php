...
class AboutHistoryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('about_histories')->insert([
            'detail' => '<h2>มูลนิธิแก้ไขปัญหาการดื่มแอลกอฮอล์ หรือ มปอ. (Thai Foundation For Responsible Drinking: TFRD) 
                            เป็นองค์กรไม่แสวงหากำไร ก่อตั้งขึ้นใน พ.ศ. 2554 โดยการสนับสนุนของผู้ประกอบธุรกิจเครื่องดื่มแอลกอฮอล์</h2>
                           <p>
                           <br>
